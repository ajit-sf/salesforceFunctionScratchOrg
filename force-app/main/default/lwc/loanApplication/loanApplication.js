...
export default class LoanApplication extends LightningElement {
    ...
    async handleUploadFinishedAadhaarFront(event) {
        ...
        let aadhaarDataFront = await fetchTextFromImages({downloadableLink : downloadableUrl, type : 'aadhaarFront'});
        console.log('aadhaarDataFront' + aadhaarDataFront);
    }
    ...
    async handleUploadFinishedAadhaarBack(event) {
        ...
        let aadhaarDataFront = await fetchTextFromImages({downloadableLink : downloadableUrl, type : 'aadhaarBack'});
        console.log('aadhaarDataBack' + aadhaarDataFront);
    }
